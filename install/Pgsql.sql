...
--
-- Table structure for table "typecho_user_tokens"
--
CREATE SEQUENCE "typecho_user_tokens_seq";

CREATE TABLE "typecho_user_tokens" (
  "id" INT NOT NULL DEFAULT nextval('typecho_user_tokens_seq'),
  "userId" INT NOT NULL,
  "token" TEXT NOT NULL,
...
CREATE INDEX "typecho_user_tokens_userId" ON "typecho_user_tokens" ("userId");